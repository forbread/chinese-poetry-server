...
const shenglvqimengControllers = require('../controllers/mengxue/shenglvqimeng');
const zengguangxianwenControllers = require('../controllers/mengxue/zengguangxianwen');
...
router.get('/mengxue/shenglvqimeng/list', shenglvqimengControllers.getList)
router.get('/mengxue/zengguangxianwen/list', zengguangxianwenControllers.getList)
